        ...
        <div className="max-w-4xl mx-auto">
          <div className="border-2 border-[#25D366] rounded-2xl p-6 md:p-8 text-center bg-background/50">
            ...
            <Button
              ...
              onClick={() => window.open('https://api.whatsapp.com/send/?phone=556181720408&text=Ol%C3%A1%2C+quero+tirar+algumas+d%C3%BAvidas+sobre+a+Rise+Community.&type=phone_number&app_absent=0&utm_source=organic', '_blank')}
            >
